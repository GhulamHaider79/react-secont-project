                    ...
                    <div className="max-w-xl sm:mt-1 mt-80 space-y-8  sm:text-right sm:ml-auto">
                        <h2 className="text-4xl font-bold sm:text-5xl text-left">
                           ...
                           <span className='text-3xl mt-4 hidden sm:block '>
                            ...
                            <span className="hidden sm:block text-xl mt-4">I am a passionate Web and Mobile App Developer with 1 year of experience in crafting dynamic and responsive applications.
                                ...
                                strong foundation in front-end development, I am committed to delivering high-quality solutions that enhance user experience and meet business objectives.</span>
                        </h2>
